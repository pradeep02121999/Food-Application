...
public class AuthController {
	...
	@PostMapping("/signup")
	public ResponseEntity<AuthResponse> createUserHandler(@Valid @RequestBody Client client) throws UserException {
		...
		Client isEmailExist = userRepository.findByEmail(email);
		...
		Client savedUser = userRepository.save(createdUser);
...
//		savedUser.setCart(savedCart);
	...
	@PostMapping("/reset-password")
	 public ResponseEntity<ApiResponse> resetPassword(
	        ...
	        userService.updatePassword(client, req.getPassword());
	 ...
	 @PostMapping("/reset-password-request")
	    public ResponseEntity<ApiResponse> resetPassword(@RequestParam("email") String email) throws UserException {
	        Client client = userService.findUserByEmail(email);
	        ...
	        userService.sendPasswordResetEmail(client);
